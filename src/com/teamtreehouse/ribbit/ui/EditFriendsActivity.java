...
public class EditFriendsActivity extends Activity {
	...
	protected TextView mEmptyEextView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.user_grid_view);
		// Show the Up button in the action bar.
		setupActionBar();
		
		mGridView = (GridView) findViewById(R.id.friendGridView);
		mEmptyEextView = (TextView)findViewById(android.R.id.empty);
		mGridView.setEmptyView(mEmptyEextView);
